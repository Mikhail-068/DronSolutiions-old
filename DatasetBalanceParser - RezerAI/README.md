...
Для данного датасета данный дисбаланс этого мажорного класса будет повторяться при каждом последующем отборе из этого датасета выборки в данном случае либо с порогом в 500 либо с любым другим порогом.
