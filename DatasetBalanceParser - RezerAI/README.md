...
Для данного датасета данный дисбаланс этого мажорного класса будет повторяться при каждой последующей из него выборке с в данном случае порогом в 500 либо другим порогом.
